...
A presentation and control layer over the recorded artifacts; it adds no capability to
the protocol. Its rules live in `frontend/CLAUDE.md`, which loads when working there.
